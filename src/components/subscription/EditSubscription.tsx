...
console.log(subscription.nextBillingDate);
  ...
  return (
    <div className="space-y-6 dark:text-gray-900">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div className="col-span-2">
            ...
            <input
              {...register("name")}
              className="w-full mt-1 p-4 bg-gray-50 rounded-2xl border-none"
            />
          </div>
        ...
        <div className="flex gap-3 pt-4">
          ...
          <button
            disabled={isPending}
            className="flex-[2] bg-[#10b981] cursor-pointer text-white py-4 rounded-2xl font-black"
          >
            {isPending ? (
