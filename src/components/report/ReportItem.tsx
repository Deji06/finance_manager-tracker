import { FileText, ChevronRight, TrendingDown, TrendingUp } from "lucide-react";
import { formatCurrency } from "../../utils/format";
import type { ReportType } from "../../types/financial";

export const ReportItem = ({ report, onClick }: { report: ReportType; onClick: () => void }) => {
    ...
    >
      ...
      <div className="flex items-center gap-8">
        <div className="hidden md:block text-right">
          <p className="text-xs text-gray-400 uppercase font-bold tracking-wider">Net Savings</p>
          <p className={`font-black ${isPositive ? 'text-[#10B981]' : 'text-red-500'}`}>
